...
class ParticipantController {
    constructor() {
        ...
        this.participantService = new participant_1.ParticipantService();
    }
    joinEvent(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield this.participantService.joinEvent(uid, eventId);
    ...
    getAllJoinedEvents(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const uid = req.user.uid;
                const dto = (0, class_transformer_1.plainToInstance)(dtos_1.SearchDto, req.query);
                const result = yield this.participantService.getAllJoinedEvents(uid, dto);
